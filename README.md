...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-slvhfq4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-slvhfq4.containers.anotherwebservice.com/
...
```
git clone git@github.com:12to12tech/container-slvhfq4.git
cd container-slvhfq4
```
...
```
docker attach container-slvhfq4
```
